...
```{r, message = FALSE, results = "hide", warning = FALSE, echo = FALSE,out.width='80%',fig.align='center',fig.pos='htbp', fig.cap="\\label{fig:cap05gg02}Porcentaje de pobreza por regiones}
