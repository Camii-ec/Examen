...
Además, se comprobó que no es posible realizar un análisis de regresión lineal el cual intente explicar los ingreso autónomo per cápita del hogar corregido. Al analizar los ingresos se observa que existe una importante cantidad de 
